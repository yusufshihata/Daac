...
const testimonials: TestimonialAttributes[] = [
  ...
  },
  {
    ...
    content: `Promoting the health and well-being of families is my passion. At this clinic, we provide comprehensive healthcare products that focus on preventive care and maintaining a healthy lifestyle. It's a privilege to be a part of our patients' wellness journeys.`
  }
];
